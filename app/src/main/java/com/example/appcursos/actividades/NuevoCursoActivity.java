...
public class NuevoCursoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String []numAlumnos={"5","10","15","20","25","30"};
            ...
            public void onClick(View view) {
                if (validarDatos()) {
                    ...
                    if (cant == 1) {
                        ...
                        Intent intent = new Intent(NuevoCursoActivity.this, CursosActivity.class);
        ...
        b_cancelarCurso.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent cancelar_curso = new Intent(NuevoCursoActivity.this, CursosActivity.class);
